...
DEFAULT_FROM_EMAIL = os.environ.get(
    "DEFAULT_FROM_EMAIL",
    "Mainline-AI <no-reply@mainline.ai>"
)
...
# Build URI only if all variables exist
if DB_USER and DB_PASSWORD and DB_CLUSTER:
    MONGO_URI = (
    ...
    logger.warning(
        "MongoDB env vars missing. Running WITHOUT DB connection."
    )

# Connect only if valid
if MONGO_URI:
    try:
        ...
        logger.error(f"MongoDB connection failed: {e}")
        # DO NOT crash Django in production-safe mode
